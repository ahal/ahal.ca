...
SITE_ID = config.get('general', 'site_id')
...
STATIC_URL = config.get('staticfiles', 'url')
...
STATICFILES_DIRS = (
    ...
    config.get('static', 'admin'),
    config.get('static', 'content'),
)
